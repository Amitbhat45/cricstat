...
fun Testbowling1(text: String, index: Int): Deferred<Pair<List<String>, List<String>>> {
    ...
    val deferredData = coroutineScope.async {
        try {
            ...
            val doc: Document = Jsoup.connect("http://www.cricmetric.com/playerstats.py?player=${text.split(" ")[0]}+${text.split(" ")[1]}&role=bowler&format=Test&groupby=year&playerStatsFilters=on&start_date=2002-01-01&end_date=$formattedDate&start_over=0&end_over=9999&max_innings=1000")
                .timeout(100000)
